...
<head>
	...
	<title>Niendoo Tech POS | Dashboard</title>
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="dashboard.php" class="logo">
				...
				<span class="logo-lg"><b>N-TECH </b>POS</span>
			</a>
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header">
									...
									<p>
										...
										<small><?php $currentDateTime = date('Y-m-d'); echo 'Today\'s Date: '.$currentDateTime;?></small>

										<small><?php $currentDateTime = date('H:i:s'); echo 'Time: '.$currentDateTime;?></small>
									</p>
								</li>
								<!-- Menu Body -->
								<li class="user-body">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					<li class="header">Admin Dashoboard</li>
					<!-- Optionally, you can add icons to the links -->
					<li class="active"><a href="dashboard.php"><i class="fa fa-tachometer"></i> <span>Dashboard</span></a></li>
					<li><a href="category.php"><i class="fa fa-list"></i> <span>Categories</span></a></li>
					<li><a href="expenses.php"><i class="fa fa-list"></i> <span>Expenses</span></a></li>
					<li><a href="suppliers.php"><i class="fa fa-list"></i> <span>Suppliers</span></a></li>
					<li class="treeview">
					...
					<li class="treeview">
						<a href="#"><i class="fa fa-first-order"></i> <span>Orders</span>
							<span class="pull-right-container">
								<i class="fa fa-angle-left pull-right"></i>
							</span>
						</a>
						<ul class="treeview-menu">
						<li><a href="createorder.php"><i class="fa fa-cart-plus"></i> <span>Create Order</span></a></li>
          ...
          <ul class="treeview-menu">
            <li><a href="tablereport.php"><i class="fa fa-circle-o"></i>Tabular Report</a></li>
            <li><a href="graphreport.php"><i class="fa fa-circle-o"></i> Graph Report</a></li>
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li><a href="registration.php"><i class="fa fa-registered"></i> User Registration </a></li>
